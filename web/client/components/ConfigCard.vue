<template>
  <v-card class="config-card mb-4" :class="{ 'editing': isDirty }">
    <!-- 头部 -->
    <div class="card-header pt-4 px-4 pb-2 d-flex align-center justify-space-between" style="border-bottom: 1px dashed rgba(0,0,0,0.05);">
      <div class="d-flex align-center flex-grow-1 mr-2" style="min-width: 0;">
        ...
        <div class="flex-grow-1" style="min-width: 0;">
          <v-text-field
            ...
            density="compact"
            hide-details
            class="title-input font-weight-bold ml-n1 text-grey-darken-3"
            placeholder="配置名称"
      ...
      <div class="actions flex-shrink-0 d-flex align-center">
        <v-btn
          ...
          size="x-small"
          variant="flat"
          class="mr-2 fade-in round-btn elevation-2"
          :loading="saving"
          @click="handleSave"
        >
          保存
